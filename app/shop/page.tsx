...
// Hardcoded shop products — same as the original shop
const SHOP_PRODUCTS = [
...
export default function ShopPage() {
  const { addLocalShopItem } = useCart();
  ...
  // Map each shop product to a DB product by index for cart purposes
            ...
            >
              ...
              <div className="flex flex-col justify-center w-full md:w-1/2">
                ...
                <button
                  ...
                  className="w-full bg-[#91A57D] hover:bg-[#7a8d67] text-white py-4 rounded-xl font-bold text-lg shadow-sm transition-colors flex items-center justify-center gap-2"
                >
